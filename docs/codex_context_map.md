...
トークン節約ルールは `docs/codex_token_budget.md` を参照します。
...
- `docs/chatgpt_handoff_prompt.md`: PC版ChatGPT相談用プロンプト
- `docs/codex_token_budget.md`: Codex使用量を抑える運用ルール
- `docs/codex_light_task_templates.md`: Codexへ渡す軽量タスクテンプレ
